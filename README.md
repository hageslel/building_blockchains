...
The first step to allow access to launching the blockchain will be to ensure all Go Ethereum (geth) tools are installed.  Additionally, a MyCrypto wallet will need to be created.  Instructions to complete both tasks can be found here: [a link](https://github.com/hageslel/building_blockchains/blockchain-install-guide.md)
